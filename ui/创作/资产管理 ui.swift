// ============================================================
//  文件作用：资产管理。AssetCategory / AssetItem 资产模型、AssetStore 单例
//  （导入/按项目过滤/重命名资产）、AssetManagementView 管理页（资产网格 +
//  属性管理面板 + 批量管理）。
//  互动文件：AssetStore / AssetCategory 被 画布 ui.swift、交互.swift、
//  画布 状态.swift、画布 资产面板.swift 引用；AssetManagementView 被 主ui.swift 引用。
// ============================================================
// ============================================================
//  无限画布 · 资产管理
// ============================================================
