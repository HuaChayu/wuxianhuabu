...
//    · melSpectrogramStereo：立体声 PCM → log-mel NCHW [1,2,T,64]—— 使用方：LTX-2.5（AudioVaeDecoder）
//  ============================================================
...
/// Interleaved 立体声 16kHz PCM → log-mel NCHW [1, 2, T, 64]。
func melSpectrogramStereo(pcm: [Float]) -> MLXArray {
    ...
    let basis = buildEncMelFilterbank()              // [64, 513]
